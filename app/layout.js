...
{
  title: "BMA - Bindu Marine Academy | Level Up Your Marine Engineering Career",
  description: "Journey to becoming a top-tier marine engineer starts here!",
  icons: {
    icon: [
      //! Android Icons
...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      <meta name="keywords" content="BMA, Bindu, Marine, Engineer"/>
      <meta property="og:title" content="BMA - Bindu Marine Academy"/>  
      <meta property="og:description" content="Journey to becoming a top-tier marine engineer starts here!"/>
      <meta property="og:image" content="BMA"/>
      <body
